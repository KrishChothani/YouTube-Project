     ...
     const fetchVideos = async () => {
       try {
         ...
         if (callVideo === "watchhistory" && currUser) {
           res = await axios.get("http://localhost:8000/api/v1/users/history",{withCredentials:true});
         } else {
           res = await axios.get("http://localhost:8000/api/v1/videos",{withCredentials:true});
         }
     ...
     const fetchLikedVideos = async () => {
       try {
         if (callVideo === "likedVideo" && currUser) {
           const resp = await axios.get("http://localhost:8000/api/v1/likes/video",{withCredentials:true});
     ...
     const fetchLikedVideos = async () => {
       try {
         if (callVideo === "" && currUser) {
           const resp = await axios.get("http://localhost:8000/api/v1/likes/video", {
             withCredentials: true,
           });
           const videodata = resp.data.data;
           setVideos(videodata);
