    ...
    <>
      <div class="grid gap-4 pt-2 sm:grid-cols-[repeat(auto-fit,_minmax(400px,_1fr))]">
        ...
        <div class="w-full">
              ...
              <div class="absolute inset-x-0 bottom-0">
                <div class="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                  <div class="relative z-[1]">
                    <p class="flex justify-between">
                      <span class="inline-block">Playlist</span>
                      <span class="inline-block">1 videos</span>
                    </p>
                    <p class="text-sm text-gray-200">
          ...
          <h6 class="mb-1 font-semibold">JavaScript Fundamentals</h6>
          <p class="flex text-sm text-gray-200">
              ...
              <div class="absolute inset-x-0 bottom-0">
                <div class="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                  <div class="relative z-[1]">
                    <p class="flex justify-between">
                      <span class="inline-block">Playlist</span>
                      <span class="inline-block">2 videos</span>
                    </p>
                    <p class="text-sm text-gray-200">90K Views · 4 hours ago</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <h6 class="mb-1 font-semibold">TypeScript Essentials</h6>
          <p class="flex text-sm text-gray-200">
              ...
              <div class="absolute inset-x-0 bottom-0">
                <div class="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                  <div class="relative z-[1]">
                    ...
                    <p class="text-sm text-gray-200">80K Views · 5 hours ago</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <h6 class="mb-1 font-semibold">React State Management</h6>
          <p class="flex text-sm text-gray-200">
        ...
        <div class="w-full">
          ...
          <h6 class="mb-1 font-semibold">Advanced JavaScript Techniques</h6>
          <p class="flex text-sm text-gray-200">
