                ...
                <div class="fixed inset-x-0 top-full z-[60] h-[calc(100%-69px)] overflow-auto rounded-lg border bg-[#121212] p-4 duration-200 hover:top-[67px] peer-focus:top-[67px] sm:static sm:h-auto sm:max-h-[500px] lg:max-h-none">
                  ...
                  <div>
                    <div class="flex gap-x-4">
                      ...
                      <div class="block">
                        <p class="flex items-center text-gray-200">
                          Emily Turner · <span class="text-sm">1 hour ago</span>
                        </p>
                        <p class="text-sm text-gray-200">@emilyt</p>
                        <p class="mt-3 text-sm">
                          Higher-order components have been a mystery to me htmlFor
                          far too long. Looking htmlForward to demystifying them
                  ...
                  <div>
                    <div class="flex gap-x-4">
                      ...
                      <div class="block">
                        <p class="flex items-center text-gray-200">
                          David Chen · <span class="text-sm">3 hour ago</span>
                        </p>
                  ...
                  <div>
                    <div class="flex gap-x-4">
                      ...
                      <div class="block">
                        <p class="flex items-center text-gray-200">
                          Alex Parker · <span class="text-sm">12 hour ago</span>
                        </p>
                        <p class="text-sm text-gray-200">@alex_p</p>
                        <p class="mt-3 text-sm">
                          Controlled vs. uncontrolled components - finally! This
                          topic has always confused me. Thanks htmlFor breaking it
                          down!
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    <div class="flex gap-x-4">
                      ...
                      <div class="block">
                        <p class="flex items-center text-gray-200">
                          Jessica Lee · <span class="text-sm">5 hour ago</span>
                        </p>
                  ...
                  <div>
                    <div class="flex gap-x-4">
                      ...
                      <div class="block">
                        <p class="flex items-center text-gray-200">
                          Ryan Jackson · <span class="text-sm">Just now</span>
                        </p>
                        <p class="text-sm text-gray-200">@ryanjax</p>
                        <p class="mt-3 text-sm">
                          This is exactly what I needed to take my React skills
                          to the next level. Looking htmlForward to diving into the
