...
function EdminDashboardPage() {
 ...
 useEffect(() => {
   const fetchVideoData = async () => {
     try {
       const res = await axios.get("https://youtube-backend-psi.vercel.app/videos", {withCredentials:true});
 ...
 useEffect(() => {
   const fetchSubscriptions = async () => {
     try {
       if (admin) {
         const res = await axios.get(
           `https://youtube-backend-psi.vercel.app/subscriptions/u/${admin._id}`,
           { withCredentials: true }
         );
